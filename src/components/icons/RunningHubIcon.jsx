...
export function RunningHubLogomark({
  ...
  const isCompact = compact ?? classNames.includes("executionModeIcon");

  return (
    <svg
      width={size}
      height={size}
      viewBox={isCompact ? VIEWBOX_COMPACT : VIEWBOX_DEFAULT}
      fill="none"
