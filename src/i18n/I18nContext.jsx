...
const messages = {
  vi: { ...extraMessages.vi,
    ...
    "info.update": "Mới trong v1.2.0",
    "info.updateText": "Export và import template dạng .zip, kéo-thả JSON/YAML/.zip/thư mục vào Template Editor, tự quét thư viện checkpoint & LoRA SDVN cho node loader SDVN, field boolean kiểu nút gạt, bố cục Template Editor gọn hơn, ứng dụng iOS aPix Builder (beta).",
    ...
    "field.searchChoices": "Gõ để tìm...",
    "field.searchNoMatch": "Không có kết quả khớp",
  ...
  en: { ...extraMessages.en,
    ...
    "info.update": "New in v1.2.0",
    "info.updateText": "Export and import templates as .zip, drag and drop JSON/YAML/.zip/folders into the Template Editor, auto-scan of SDVN checkpoint & LoRA libraries for SDVN loader nodes, switch-style boolean fields, cleaner Template Editor layout, aPix Builder iOS app (beta).",
    ...
    "field.searchChoices": "Type to search...",
    "field.searchNoMatch": "No matching choices",
